...
export const mockEvents: CalendarEventType[] = [
  // MONDAY
  {
    ...
    title: 'Event1',
    start: returnDayDate(currentDate, 1) + 'T01:00:00',
    end: returnDayDate(currentDate, 1) + 'T10:00:00',
    overlapping: 3,
    color: '#aa90f8',
    textColor: '#FFFFFF',
  },
  ...
  // THURSDAY
  {
    ...
    title: 'Event7',
    start: returnDayDate(currentDate, 4) + 'T21:30:00',
    end: returnDayDate(currentDate, 4) + 'T23:00:00',
    overlapping: 1,
    color: '#aa90f8',
    textColor: '#FFFFFF',
  },
  ...
  // FRIDAY
  {
    ...
    title: 'Event10',
    start: returnDayDate(currentDate, 5) + 'T05:00:00',
    end: returnDayDate(currentDate, 5) + 'T14:15:00',
    overlapping: 3,
    color: '#8aa9f9',
    textColor: '#FFFFFF',
  },
  ...
  // SATURDAY
  {
    ...
    title: 'Event12',
    start: returnDayDate(currentDate, 6) + 'T16:00:00',
    end: returnDayDate(currentDate, 6) + 'T23:50:00',
    overlapping: 0,
    color: '#C0CA33',
    textColor: '#1F1F1F',
  },
  ...
  // SUNDAY
  {
    ...
    title: 'Event13',
    start: returnDayDate(currentDate, 7) + 'T04:00:00',
    end: returnDayDate(currentDate, 7) + 'T07:00:00',
    overlapping: 0,
    color: '#aa90f8',
    textColor: '#FFFFFF',
  },
